    ...
    <div class="card form-container shadow">
        ...
        <div class="card-body">
            <form action="AddDoctor" method="post">
            	...
            	<div class="row mb-3">
                    <label for="id" class="col-sm-3 col-form-label text-end">Doctor Id : </label>
                    <div class="col-sm-9 pe-5">
                        <input type="number" class="form-control" id="id" name="id" placeholder="Enter Id" autofocus="autofocus" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <label for="qualification" class="col-sm-3 col-form-label text-end">Qualification : </label>
                    <div class="col-sm-9 pe-5">
